...
description: Fish swimming behavior in light at constant 30C
assetsSummary: {'species': [{'name': 'Danio rerio - Zebra fish', 'schemaKey': 'SpeciesType', 'identifier': 'http://purl.obolibrary.org/obo/NCBITaxon_7955'}], 'approach': [{'name': 'behavioral approach', 'schemaKey': 'ApproachType'}], 'schemaKey': 'AssetsSummary', 'dataStandard': [{'name': 'Neurodata Without Borders (NWB)', 'schemaKey': 'StandardsType', 'identifier': 'RRID:SCR_015242'}], 'numberOfBytes': 189439689, 'numberOfFiles': 20, 'numberOfSubjects': 20, 'variableMeasured': ['Position', 'ProcessingModule', 'CompassDirection', 'BehavioralTimeSeries', 'SpatialSeries'], 'measurementTechnique': [{'name': 'behavioral technique', 'schemaKey': 'MeasurementTechniqueType'}, {'name': 'analytical technique', 'schemaKey': 'MeasurementTechniqueType'}]}

Dandiset 000704 has 20 NWB files.
20 of these NWB files are of type 1.


Here is a summary of the type 1 NWB files:
  Group / (NWBFile) 
  file_create_date: ['2023-11-10T11:52:10.524516-05:00']
  Group /general/devices/GradientChamber_1 (Device) OSU Haesemeyer Lab, Gradient Behavior Chamber 1
  experiment_description: Experiment name: Temp_pref_F30_B30_5dpf_01
  
  Fish name: unsorted_nac
  
  Fish DOB: 8/3/2023 12:00:00 AM
  ...
  8/8/2023 11:48:47 AM
  
  experimenter: ['Kaarthik Balakrishnan']
  institution: THE Ohio State University
  Group /general/subject (Subject) 
  identifier: Temp_pref_F30_B30_5dpf_01_unsorted_nac
  ...
  Dataset /scratch/Raw Experiment metadata (ScratchData)  | shape = () | dtype = <U395
  Dataset /scratch/Right fish (ScratchData)  | shape = () | dtype = <U8
  session_description: Hot Avoidance behavior
  session_start_time: 2023-08-08T11:18:00-04:00
  timestamps_reference_time: 2023-08-08T11:18:00-04:00
