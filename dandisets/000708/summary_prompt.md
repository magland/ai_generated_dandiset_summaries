...
description: Fish swimming behavior in thermal gradient from 24C to 32C in the light
assetsSummary: {'species': [{'name': 'Danio rerio - Zebra fish', 'schemaKey': 'SpeciesType', 'identifier': 'http://purl.obolibrary.org/obo/NCBITaxon_7955'}], 'approach': [{'name': 'behavioral approach', 'schemaKey': 'ApproachType'}], 'schemaKey': 'AssetsSummary', 'dataStandard': [{'name': 'Neurodata Without Borders (NWB)', 'schemaKey': 'StandardsType', 'identifier': 'RRID:SCR_015242'}], 'numberOfBytes': 166472363, 'numberOfFiles': 17, 'numberOfSubjects': 17, 'variableMeasured': ['BehavioralTimeSeries', 'ProcessingModule', 'Position', 'SpatialSeries', 'CompassDirection'], 'measurementTechnique': [{'name': 'behavioral technique', 'schemaKey': 'MeasurementTechniqueType'}, {'name': 'analytical technique', 'schemaKey': 'MeasurementTechniqueType'}]}

Dandiset 000708 has 17 NWB files.
17 of these NWB files are of type 1.


Here is a summary of the type 1 NWB files:
  Group / (NWBFile) 
  file_create_date: ['2023-11-10T11:53:21.107078-05:00']
  Group /general/devices/GradientChamber_1 (Device) OSU Haesemeyer Lab, Gradient Behavior Chamber 1
  experiment_description: Experiment name: Temp_pref_F32_B24_5dpf_11
  
  Fish name: unsorted_nac
  
  Fish DOB: 10/19/2023 12:00:00 AM
  ...
  session_start_time: 2023-10-24T12:13:00-04:00
  timestamps_reference_time: 2023-10-24T12:13:00-04:00
